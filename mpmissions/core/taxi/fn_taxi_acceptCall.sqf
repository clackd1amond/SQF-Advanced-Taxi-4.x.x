...
hint format ["You have accepted the taxi call of %1. He is %2 meters away from you current location. The location has been marked on your map.",name _player,floor(player distance _player)];

life_taxiCustomer = _player;
life_taxiDriver = player;
